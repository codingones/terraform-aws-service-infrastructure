...
resource "github_repository_file" "terraform_apply" {
  ...
  content             = (var.force_recreate_all_github_templated_files || data.http.terraform_apply.response_body == "404: Not Found") ? module.workflow_template.rendered : data.http.terraform_apply.response_body
